...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o: ../contracts/simple.token/simple.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o"
	cd /root/eos/build/contracts/simple.token && /usr/bin/clang++-4.0   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o -c /root/eos/contracts/simple.token/simple.token.cpp
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i: cmake_force
	...
	cd /root/eos/build/contracts/simple.token && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/eos/contracts/simple.token/simple.token.cpp > CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s: cmake_force
	...
	cd /root/eos/build/contracts/simple.token && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/eos/contracts/simple.token/simple.token.cpp -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s
...
contracts/simple.token/simple.token.tmp: contracts/simple.token/CMakeFiles/simple.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable simple.token.tmp"
	cd /root/eos/build/contracts/simple.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/simple.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/clean:
	cd /root/eos/build/contracts/simple.token && $(CMAKE_COMMAND) -P CMakeFiles/simple.token.tmp.dir/cmake_clean.cmake
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/depend:
	cd /root/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/eos /root/eos/contracts/simple.token /root/eos/build /root/eos/build/contracts/simple.token /root/eos/build/contracts/simple.token/CMakeFiles/simple.token.tmp.dir/DependInfo.cmake --color=$(COLOR)
