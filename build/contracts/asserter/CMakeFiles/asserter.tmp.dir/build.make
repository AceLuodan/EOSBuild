...
contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.o: ../contracts/asserter/asserter.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.o"
	cd /root/eos/build/contracts/asserter && /usr/bin/clang++-4.0   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/asserter.tmp.dir/asserter.cpp.o -c /root/eos/contracts/asserter/asserter.cpp
...
contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.i: cmake_force
	...
	cd /root/eos/build/contracts/asserter && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/eos/contracts/asserter/asserter.cpp > CMakeFiles/asserter.tmp.dir/asserter.cpp.i
...
contracts/asserter/CMakeFiles/asserter.tmp.dir/asserter.cpp.s: cmake_force
	...
	cd /root/eos/build/contracts/asserter && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/eos/contracts/asserter/asserter.cpp -o CMakeFiles/asserter.tmp.dir/asserter.cpp.s
...
contracts/asserter/asserter.tmp: contracts/asserter/CMakeFiles/asserter.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable asserter.tmp"
	cd /root/eos/build/contracts/asserter && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/asserter.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/asserter/CMakeFiles/asserter.tmp.dir/clean:
	cd /root/eos/build/contracts/asserter && $(CMAKE_COMMAND) -P CMakeFiles/asserter.tmp.dir/cmake_clean.cmake
.PHONY : contracts/asserter/CMakeFiles/asserter.tmp.dir/clean

contracts/asserter/CMakeFiles/asserter.tmp.dir/depend:
	cd /root/eos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/eos /root/eos/contracts/asserter /root/eos/build /root/eos/build/contracts/asserter /root/eos/build/contracts/asserter/CMakeFiles/asserter.tmp.dir/DependInfo.cmake --color=$(COLOR)
