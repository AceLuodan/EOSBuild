# Install script for directory: /root/eos/programs/keosd
...
file(INSTALL DESTINATION "/usr/local/eosio/bin" TYPE EXECUTABLE FILES "/root/eos/build/programs/keosd/keosd")
  if(EXISTS "$ENV{DESTDIR}/usr/local/eosio/bin/keosd" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/eosio/bin/keosd")
